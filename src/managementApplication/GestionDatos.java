...
public class GestionDatos {
    ...
    public static void inicializarDatos() {
        ...
        ArrayIncidencias[0] = new Incidencia(1, "Manolo", "Se me ha caido todo el pelo por hecharme ese champú", false);
        ArrayIncidencias[1] = new Incidencia(2, "Manolo", "La pierna Robótica no enciende", true);
        ArrayIncidencias[2] = new Incidencia(3, "Carmen", "Mi marido manolo ha muerto por culpa de el cortauñas hidráulico", false);
    }
